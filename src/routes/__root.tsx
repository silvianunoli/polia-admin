...
function RootComponent() {
  ...
  // /conteudo-polia idem, na lista e no editor: tela cheia (pranchas, preview
  // e conteúdo lado a lado), com header próprio de volta.
  const semChrome =
    pathname === "/central" ||
    pathname === "/kanban" ||
    pathname === "/estrategico" ||
    pathname === "/conteudo" ||
    pathname.startsWith("/conteudo-polia") ||
