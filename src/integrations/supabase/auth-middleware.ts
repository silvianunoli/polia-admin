...
// Valida o Bearer token da requisição contra o MESMO projeto Supabase do
// produto (polia-app) — é JWT puro, sem cookie/sessão amarrada a domínio,
// por isso funciona cross-deploy sem redesenho de auth.
